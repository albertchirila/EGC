...
void Laborator2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["cube3"], shaders["VertexColor"], glm::vec3(1.5f, 0.5f, 0), glm::vec3(0.75f));

	RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(0, 2.f, -1.5f), glm::vec3(0.25f));
	
	RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(0.f, 3.f, 0.f), glm::vec3(0.75f));
